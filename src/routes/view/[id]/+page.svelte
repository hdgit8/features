...
<div class="flex flex-col pb-10">
    <div class="bg-cover bg-center" style="background-image:url({course.public_url})">
        <div class="flex flex-col bg-gradient-to-b from-transparent to-black">
            <div class="flex flex-col gap-2 p-5 mx-auto w-full">
                <iframe class="md:w-2/3 w-full mx-auto aspect-video rounded-lg" src="https://www.youtube.com/embed/KhCeUKdNrl0?autoplay=1" title="YouTube Video Player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                <div class="w-full text-lg pt-10 font-semibold text-center my-auto mx-auto">
