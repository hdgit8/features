...
<div class="fixed z-50 top-0 left-0 right-0 bottom-0 bg-[--dark-800] p-3 overflow-y-scroll">
    <div class="flex">
        ...
        <button on:click={()=>{showStudioView = false}} class="ml-auto opacity-50 hover:opacity-100 p-2 px-3 rounded-full text-white bg-black">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4">
    ...
    <div class="flex flex-col gap-2">
        <MediaEdit {supabase} section_embeds={section.section_embeds} section_codecasts={section.section_codecasts} sectionId={section.id}></MediaEdit>
