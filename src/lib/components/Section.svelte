...
<div class="flex section font-medium hover:bg-[--dark-800] p-2 px-3 rounded text-white opacity-75 hover:opacity-90" 
class:opacity-100={$page.params.sectionId === sectionId}>
    <a href="/view/{courseId}/{moduleId}/{sectionId}">
        <span class="font-mono">[{moduleNum}.{num}]</span> {name}
    </a>
